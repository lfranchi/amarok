...
#ifndef TOMAHAWKTOMAHAWK_ACCOUNTS_ACCOUNTMODEL_H
#define TOMAHAWKTOMAHAWK_ACCOUNTS_ACCOUNTMODEL_H
...
private:
    QList< AccountListModelNode* > m_accounts;
...
#endif // TOMAHAWKTOMAHAWK_ACCOUNTS_ACCOUNTMODEL_H
