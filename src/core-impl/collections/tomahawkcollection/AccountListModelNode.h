...
#ifndef TOMAHAWKTOMAHAWK_ACCOUNTS_ACCOUNTMODELNODE_H
#define TOMAHAWKTOMAHAWK_ACCOUNTS_ACCOUNTMODELNODE_H
...
struct AccountListModelNode {
    ...
    explicit AccountListModelNode( AccountFactory* fac ) : type( FactoryType )
    {
        init();
        factory = fac;
    ...
    explicit AccountListModelNode( Attica::Content cnt ) : type( AtticaType )
    {
        init();
        atticaContent = cnt;
    ...
    explicit AccountListModelNode( ResolverAccount* ra ) : type( ManualResolverType )
    {
        init();
        resolverAccount = ra;
    ...
    explicit AccountListModelNode( Account* account ) : type( CustomAccountType )
    {
        init();
