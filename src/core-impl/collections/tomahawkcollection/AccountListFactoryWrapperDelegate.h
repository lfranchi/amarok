...
#ifndef TOMAHAWKACCOUNTFACTORYWRAPPERDELEGATE_H
#define TOMAHAWKACCOUNTFACTORYWRAPPERDELEGATE_H
...
class AccountListFactoryWrapperDelegate : public QStyledItemDelegate
{
    Q_OBJECT
public:
    explicit AccountListFactoryWrapperDelegate( QObject* parent = 0 );
...
#endif // TOMAHAWKACCOUNTFACTORYWRAPPERDELEGATE_H
