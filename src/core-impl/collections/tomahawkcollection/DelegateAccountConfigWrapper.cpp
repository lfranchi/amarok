...
DelegateAccountConfigWrapper::DelegateAccountConfigWrapper( QWidget* conf, QWidget* aboutWidget, const QString& title, QWidget* parent, Qt::WindowFlags flags )
...
void
DelegateAccountConfigWrapper::setShowDelete( bool del )
{
    if ( del )
...
void
DelegateAccountConfigWrapper::toggleOkButton( bool dataError )
{
...
void
DelegateAccountConfigWrapper::closed( QAbstractButton* b )
{
...
void
DelegateAccountConfigWrapper::rejected()
{
    layout()->removeWidget( m_widget );
    m_widget->setParent( 0 );
    m_widget->setVisible( false );
...
void
DelegateAccountConfigWrapper::updateSizeHint()
{
    hide();
    setSizeGripEnabled( false );
    setMinimumSize( sizeHint() );
...
void
DelegateAccountConfigWrapper::aboutClicked( bool )
{
    Q_ASSERT( m_aboutW );
    m_aboutW->show();
