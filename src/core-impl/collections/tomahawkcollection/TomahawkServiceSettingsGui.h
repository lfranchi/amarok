 ...
 */
class TomahawkServiceSettingsGui : public TomahawkSettings
{
Q_OBJECT

public:
    static TomahawkServiceSettingsGui* instanceGui();

    explicit TomahawkServiceSettingsGui( QObject* parent = 0 );
    virtual ~TomahawkServiceSettingsGui();
